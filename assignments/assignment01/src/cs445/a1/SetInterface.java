...
public interface SetInterface<E> {
     ...
     */
    boolean add(E newEntry) throws cs445.a1.SetFullException,
     ...
     */
    E remove(E entry) throws NullPointerException;
     ...
     * @throws NullPointerException  If entry is null
     */
    boolean contains(E entry) throws NullPointerException;
